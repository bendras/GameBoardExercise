...
namespace GameBoardExercise.Types
{
    /// <summary>Describes position and direction in the world.</summary>
    public struct PositionVector
    {
        ...
        public PositionVector(int x, int y, Direction direction)
            : this()
        {
            this.X = x;
            this.Y = y;
        ...
        {
            return string.Format("({0},{1},{2})", this.X, this.Y, this.Direction.ToString()[0]);
        }
    }
}
